...
const double ATTENUATION_FACTOR = 0.2;
...
// Basic direct lighting with point lights, shadow test, and distance attenuation
...
void buildTestScene(std::vector<Material>& materials,
    ...
    // Simple test lights
    Light mainLight;
    mainLight.position = Vector3(2.0, 3.0, 2.0);
    mainLight.colour = Vector3(1.0, 1.0, 1.0);
    mainLight.intensity = 3.0;
    lights.push_back(mainLight);

    Light fillLight;
    fillLight.position = Vector3(-2.0, 2.0, 1.0);
